...
public class CreateImportWarehouse  extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        top.getChildren().addAll(inputField, datePicker);
        ...
        buyNowButton.setOnAction(e -> {
            if (!cartItems.isEmpty()) {
                if (ImportInvoiceModel.createImportInvoiceWarehouse(inputField.getText(), cm.getWarehouseNameById(idWarehouse), totalSalePrice, selectedDate.toString(), cartItems) == -1) {
